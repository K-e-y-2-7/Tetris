...
screen_canv = tkinter.Canvas(tetris, width=RES[1], height=RES[0],
                        bg='#6C00B5', highlightthickness=0)
screen_canv.pack()

# Create a screen to field of game
game_screen_canv = tkinter.Canvas(tetris, width=WIDTH * TILE + 1,
...
top_10_canv = tkinter.Canvas(tetris, width=310,
